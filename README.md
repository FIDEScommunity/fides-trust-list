...
This repository hosts the **FIDES Sandbox List of Trusted Lists (LOTL)** and the **FIDES Sandbox Trusted List (TL)** used in pilots around **business wallets**, **personal wallets** and **verifiable credentials**.
